...
public class VehiculoService implements GenericService<Vehiculo>  {
   ...
   private final VehiculoDao vehiculoDao;
    ...
    // 2. AÑADIR ESTE CONSTRUCTOR
    // Main.java llamará a este constructor para "inyectar" los DAOs
    public VehiculoService(VehiculoDao vDao, SeguroVehicularDao sDao) {
        this.vehiculoDao = vDao;
        this.seguroDao = sDao;
    }
    ...
    public void eliminar(long id) {
        ...
        try {
            if (conn != null) conn.rollback(); // 4. Rollback
        } catch (SQLException ex) {
